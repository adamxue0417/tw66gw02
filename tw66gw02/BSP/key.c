                ...
                void(*Key1VeryLongPress)(void))
{
    for (uint8_t i = 0; i < KeyNumber; i++)
    {
        ...
        {
            case QuickPress:
                if (i == 0u) { if (Key0ShortPress != 0) { Key0ShortPress(); } }
                else { if (Key1ShortPress != 0) { Key1ShortPress(); } }
                KeyState[i] = Idle;
                break;

            case LongPress:
                if (i == 0u) { if (Key0LongPress != 0) { Key0LongPress(); } }
                else { if (Key1LongPress != 0) { Key1LongPress(); } }
                KeyState[i] = Idle;
                break;

            case VeryLongPress:
                if (i == 0u) { if (Key0VeryLongPress != 0) { Key0VeryLongPress(); } }
                else { if (Key1VeryLongPress != 0) { Key1VeryLongPress(); } }
                KeyState[i] = Idle;
                break;
