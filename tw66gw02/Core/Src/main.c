...
int main(void)
{
 ...
 if (SCH_Add_Task(Key_Scan, 0, 10) == SCH_MAX_TASKS) { Error_Handler(); }
 if (SCH_Add_Task(DisplayTask, 0 , 10) == SCH_MAX_TASKS) { Error_Handler(); } 
 if (SCH_Add_Task(TempGetTask, 0 , 500) == SCH_MAX_TASKS) { Error_Handler(); }
 if (SCH_Add_Task(MainControl, 0 , 100) == SCH_MAX_TASKS) { Error_Handler(); }
 if (SCH_Add_Task(WirelessTask, 0, 20) == SCH_MAX_TASKS) { Error_Handler(); }
 if (SCH_Add_Task(OtaBoot_ConfirmRunningImage, 10000, 0) == SCH_MAX_TASKS) { Error_Handler(); }
