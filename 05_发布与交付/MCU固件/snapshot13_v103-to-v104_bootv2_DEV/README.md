# snapshot13_v103-to-v104_bootv2_DEV
...
| 项目 | 说明 |
| --- | --- |
| 源工程 | `01_固件工程/development/snapshot-13_poweroff-v104/tw66gw02` |
| 版本 | 工厂 v103 → OTA v104 |
| 分区 | Bootloader 8 KiB；App `0x08002000`；槽 25 KiB |
| Bootloader | 2；manifest boot_api_version = 1，API 号与 Bootloader 迭代号分别记录 |
