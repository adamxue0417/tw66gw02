...
| 项目 | 说明 |
| --- | --- |
| 源工程 | `01_固件工程/development/snapshot-14_refactor-from-10/tw66gw02` |
| 版本 | 工厂 v100 → OTA v101 |
| 分区 | Bootloader 6 KiB；App `0x08001800`；槽 27 KiB |
| Bootloader | development / RSA verification disabled；manifest boot_api_version = 未在 manifest 声明，API 号与 Bootloader 迭代号分别记录 |
...
本次清理后重新构建并通过 OTA 检查；当前源码指纹对应本次构建。
